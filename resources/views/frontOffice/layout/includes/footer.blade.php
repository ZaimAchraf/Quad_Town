    ...
    <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-8 mb-5">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-white mr-3"></i>Kerrandou, Rich, Morocco, 52 400</p>
                <p class="mb-2"><i class="fa fa-phone-alt text-white mr-3"></i>+212 6-55869149</p>
                <p><i class="fa fa-envelope text-white mr-3"></i>quadtown22@gmail.com</p>
